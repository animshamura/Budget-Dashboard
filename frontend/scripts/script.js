...
async function fetchSubsidiaryData() {
    try {
        const response = await fetch("https://backend-shamura-ahmads-projects.vercel.app/subsidiaries/");
...
async function fetchSectorData() {
    try {
        const response = await fetch("https://backend-shamura-ahmads-projects.vercel.app/sector_spendings/");
        const data = await response.json();
